...
/**
 * CharacterClass is the abstract class that is used as the basis for other
 * character classes (Warrior, Thief, etc.) using a Decorator design pattern.
 * 
...
public abstract class CharacterClass extends PlayerCharacter {
     ...
     * Constructor.
     * 
     * @param pc the PlayerCharacter instance that will be decorated by a Character
     *           Class
     */
