...
public class GameRunner implements Mediator {
    ...
    /**
     * Starts the main game loop. Helps the user setup the player character, prints
     * the game intro, and begins running the game.
     * 
     * @throws Exception for invalid character parameters
     */
    public void initializeGame() throws Exception {
        ...
        System.out.print("At the northern border of the Shield Lands, "
                + "near the Bandit Kingdoms and the Great Rift, "
                + "stands legendary White Plume Mountain.\n"
    ...
    /**
     * Notification method of the Mediator design pattern. Used by game entities to
     * ask the Mediator to resolve a game event. Composed of a list of valid events.
     */
    @Override
    ...
    /**
     * Moves the player character to the next floor in the dungeon. Sets up the
     * floor if it still doesn't exists.
     * 
     * @throws Exception for invalid game entity parameters
     */
    ...
    /**
     * Populates a shop's inventory TODO: not finished implementing.
     */
    ...
    /**
     * Randomizes an additional 1-5 damage per attack. Keeps things interesting :).
     * 
     * @return
     */
