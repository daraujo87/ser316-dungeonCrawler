...
/**
 * Floor is the abstract class that is used as the basis 
 * for other all floor types (Shop and Dungeon).
 * Using a Decorator design pattern a floor sub type will be later
 * added on top of the base floor.
 * 
