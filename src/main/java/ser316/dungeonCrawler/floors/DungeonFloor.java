...
/**
 * Dungeon floors are used for all dungeon floors that are either infested or empty
 * 
...
public class DungeonFloor extends Floor {
	...
	/**
	 * Randomizes the new contents of the floor when you revisit it
	 * It can be filled with new enemies, with a traveling merchant, or still be empty
	 * @return
	 */
